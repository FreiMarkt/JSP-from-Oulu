  ...
  <head>
   <%
      ...
      //   int id=Integer.parseInt(roleid);
         ...
         String sql= "select ppassword,roleid from member where memberid=?";
         ...
         PreparedStatement ps2=c.prepareStatement(sql2);
         	...
         	if(rs.next()){				
					if(rs.getString(1).equals(password)&&rs.getInt(2)==1)
					 out.print("<script type=\"text/javascript\">location.href=''" +"alert('login successfully!');</script>");
					 else if (rs.getString(1).equals(password)&&rs.getInt(2)==6)
					  out.print("<script type=\"text/javascript\">location.href='member/search.jsp';</script>");
					  else out.print("<script type=\"text/javascript\">location.href='../member/frontpage.jsp';" +"alert('fail to login');</script>");	
	}
	while(rs2.next()){
