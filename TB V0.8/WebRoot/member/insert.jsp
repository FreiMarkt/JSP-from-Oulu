...
<html>
  <body>
   <%
         ...
         String sql= "INSERT INTO member(memberid,roleid,firstname,lastname,birthday,gender,email,phonenumber,address,city,postalcode,country,ppassword,paymentstatus,fiftyfivemember)VALUES (?,?,?,?,to_date(substr('"+birthday+"',1,10),'yyyy-mm-dd'),?,?,?,?,?,?,?,?,TRUE,TRUE)";
