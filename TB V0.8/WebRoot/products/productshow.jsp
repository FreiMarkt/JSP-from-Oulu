...
<div align="center">
 ...
 <td colspan="2"><span class="style2">(Ex.5 hours)</span></td>
       ...
       <tr>
        ...
        <%
         ...
         String sql= "select sellerid,productid,productdescription,productname,productcondition,shippingcondition,shippingcost,deliveryduration,numberavailable from products where productcategory=? and producttimechecks=?";
          PreparedStatement ps=c.prepareStatement(sql);
         ps.setString(1,productcategory);
         ps.setInt(2,timecheck);
               ...
               String productdescription=rs.getString("productdescription");
                String productname=rs.getString("productname");
                 String productcondition=rs.getString("productcondition");
                  String shippingcondition=rs.getString("shippingcondition");
                  int shippingcost=rs.getInt("shippingcost");
                  int deliveryduration=rs.getInt("deliveryduration");
                  int numberavailable=rs.getInt("numberavailable");
                    %>
       <tr>  
         <td bordercolor="#000000"><%out.println(sellerid);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(productid);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(productdescription);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(productname);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(productcondition);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(shippingcondition);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(shippingcost);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(deliveryduration);%>&nbsp;</td>
         <td bordercolor="#000000"><%out.println(numberavailable);%>&nbsp;</td>
       </tr>
        <% }
         stat.close();
         c.close();
