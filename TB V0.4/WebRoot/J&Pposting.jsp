...
<div align="center">
	  <table width="780" border="1" align="center" bordercolor="#33CC00" bgcolor="#33CC00">
	    <tr>
	      <td width="91"><div align="center">Home</div></td>
	      ...
	      <td width="91"><div align="center">Sign out</div></td>
	    </tr>
  </table>
</div>
<form action="J&Pmedian.jsp" method="post">
    <p align="center" class="style1">&nbsp;</p>
     <table width="433" border="1" align="center" bordercolor="#FFFFFF">
      <tr>
        <td width="276"><span class="style1">I want to search for a:</span></td>
        <td width="59"><label>
          <input name="search" type="radio" value="job">
          Job</label></td>
        <td width="76"><label>
...
<p align="center" class="style2">OR</p>
     <table width="434" border="1" align="center" bordercolor="#FFFFFF">
  <tr>
    <td width="274"><span class="style1">I want to post a new: </span></td>
    <td width="63"><label>
    <input name="post" type="radio" value="job">
Job</label></td>
    <td width="75"><label>
