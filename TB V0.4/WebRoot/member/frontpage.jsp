	...
	<div style="height: 45vh; width: 100vw;">
		...
		<div style="height: 80px; padding-left: 10vw;">
			...
			<div style="height: 100%; float: left; position: relative; width: 75vw;">
				<div id="dropDown1" class="tbix_dropdown" tabindex="1" style="float: left; top: 50%; margin-top: -22px;">category
					<ul></ul>
				</div>

				<div id="dropDown2" class="tbix_dropdown" tabindex="1" style="margin-left: 10px; float: left; top: 50%; margin-top: -22px;">subcategory
					<ul></ul>
				</div>

				<div id="dropDown3" class="tbix_dropdown" tabindex="1" style="float: left; top: 50%; margin-top: -22px; margin-left: 10px; width: 150px;">city
					<ul></ul>
				</div>
				
				<div style="float: left; position: relative; top: 50%; margin-top: -22px; margin-left: 10px; width: 150px; height: 44px; padding: 12px 5px; border-radius: 5px; background: #96c93c; text-align: center;" value="search" onclick="alert('Not implemented');">SEARCH</div>
			</div>	
		</div>		
	</div>	
