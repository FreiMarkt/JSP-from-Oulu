...
public class memberbean {
	...
	private boolean gender = null != null;
	...
	{
		boolean b = false;
		String sql1="INSERT INTO member( memberid, username, ppassword, gender, address, email, phonenumber, paymentstatus, fiftyfivemember, birthday, roleid, firstname, lastname, city, country, postalcode) VALUES ('"+memberid+"','"+username+"', '"+password+"',TRUE, '"+address+"', '"+email+"', '"+phonenumber+"', TRUE, TRUE, to_date(substr('"+birthday+"',1,10),1, '"+firstname+"', '"+lastname+"', '"+city+"', '"+country+"', "+postalcode+");";
